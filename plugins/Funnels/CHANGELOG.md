...
5.4.0 - 2026-05-11
- Fixed issue where goal steps would show Page URL not defined as entries and exits
- Fixed issue where row evolution table wouldn't load correctly
- Added funnel descriptions
...
- Added code to hide help button when step has goal comparison

5.3.11 - 2025-07-21
- Fixed non-goal funnel not working with segment

5.3.10 - 2025-07-07
- Added ability to add Funnel details and reports as a dashboard widget

5.3.9 - 2025-05-26
- Added an option to export Funnel details table
