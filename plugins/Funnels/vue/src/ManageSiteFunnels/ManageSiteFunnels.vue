      ...
      <ContentBlock :content-title="translate('Funnels_ManageFunnels')">
        ...
        <table v-content-table>
          ...
          <tr v-if="!Object.keys(funnels || {}).length">
            <td :colspan="userCanEditFunnels ? 5 : 4">
              <br/>
        ...
        <div v-form>
          <div>
            <Field
              ...
              :placeholder="translate('Funnels_FunnelNamePlaceholder')"
              :inline-help="translate('Funnels_FunnelNameInlineHelp')"
            >
            </Field>
          </div>
          <div>
            <Field
              ...
              :title="translate('Funnels_FunnelDescriptionOptional')"
              :placeholder="translate('Funnels_FunnelDescriptionPlaceholder')"
              :inline-help="translate('Funnels_FunnelDescriptionInlineHelp')"
            >
            </Field>
          </div>
          <ManageFunnel
