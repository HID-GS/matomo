...
class Funnels extends Plugin
{
    ...
    public function getClientSideTranslationKeys(&$translationKeys)
    {
        ...
        $translationKeys[] = 'Funnels_FunnelNameInlineHelp';
        $translationKeys[] = 'Funnels_FunnelNamePlaceholder';
        $translationKeys[] = 'Funnels_FunnelDescriptionOptional';
        $translationKeys[] = 'Funnels_FunnelDescriptionPlaceholder';
        $translationKeys[] = 'Funnels_FunnelDescriptionInlineHelp';
        ...
        $translationKeys[] = 'Funnels_FunnelsDetails';
        $translationKeys[] = 'Funnels_FunnelsReports';
    }
