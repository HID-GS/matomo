        ...
        <template #default="ajaxForm">
          ...
          >
            ...
            <SaveButton
              ...
              @confirm="requestSubmit(ajaxForm.submitForm)"
            />
          </ContentBlock>
          <ContentBlock
            id="samlIdPSettings"
          ...
          >
            ...
            <div name="advanced_login_saml_button_text">
              <Field
                  uicontrol="text"
                  name="advanced_login_saml_button_text"
                  v-model="actualSamlConfig.advanced_login_saml_button_text"
                  :title="translate('LoginSaml_AdvancedLoginSamlButtonText')"
                  :inline-help="loginSamlDescriptionText"
              >
              </Field>
            </div>
            <hr />
...
interface LoginSamlConfig {
  ...
  advanced_login_saml_button_text: string;
}

interface AdminState {
  actualSamlConfig: LoginSamlConfig;
  showPasswordConfirmation: boolean;
  pendingSubmit: null|(() => void);
}
...
export default defineComponent({
  ...
  data(): AdminState {
    return {
      actualSamlConfig: {
        ...(this.samlConfig as LoginSamlConfig),
  ...
  computed: {
    ...
    loginSamlDescriptionText() {
      return translate(
        'LoginSaml_AdvancedLoginSamlButtonDescription',
        '<br><br><strong>',
        '</strong>',
        translate('LoginSaml_LoginWithSSO'),
      );
    },
  },
  methods: {
    requestSubmit(submitForm: () => void) {
      this.resetDefault();
      this.pendingSubmit = submitForm;
      this.showPasswordConfirmation = true;
    },
    submitConfirmed(passwordConfirmation: string) {
    ...
    resetDefault() {
      if (!this.actualSamlConfig.advanced_login_saml_button_text) {
        this.actualSamlConfig.advanced_login_saml_button_text = translate('LoginSaml_LoginWithSSO');
      }
      this.actualSamlConfig.advanced_login_saml_button_text = Matomo.helper.htmlEntities(
        this.actualSamlConfig.advanced_login_saml_button_text,
      );
    },
  },
});
