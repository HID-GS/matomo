...
class ActivityLog extends \Piwik\Plugin
{
    ...
    public function getClientSideTranslationKeys(&$translationKeys)
    {
        ...
        $translationKeys[] = 'ActivityLog_NoActivitiesNote';
        $translationKeys[] = 'ActivityLog_NoActivitiesNoteWithLink';
        ...
        $translationKeys[] = "ActivityLog_EntityDuplicatedTypeName";
        $translationKeys[] = "ActivityLog_EntityDuplicatedTypeNameId";
        $translationKeys[] = "ActivityLog_CopySourceSite";
        $translationKeys[] = "ActivityLog_CopyDestinationSite";
        $translationKeys[] = "ActivityLog_CrashAnalyticsRequested";
        $translationKeys[] = "ActivityLog_Requested";
    }
