...
class SegmentDeleted extends Activity
{
    protected $eventName = 'SegmentEditor.deactivate';
    ...
    {
        return Piwik::translate('ActivityLog_SegmentDeleted');
    }
}
