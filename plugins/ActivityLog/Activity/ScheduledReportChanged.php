...
class ScheduledReportChanged extends Activity
{
    protected $eventName = 'API.ScheduledReports.updateReport.end';
    ...
    public function extractParams($eventData)
    {
        ...
        // $finalAPIParameters[parameters] = [ idReport, idSite, description, period, hour, reportType
        ...
        return [
            'items'     => [
                [
                    ...
                    'data' => [
                        'id'          => $finalAPIParameters['parameters']['idReport'],
    ...
    {
        return Piwik::translate('ActivityLog_ScheduledReportChanged');
    }
}
