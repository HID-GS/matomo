...
class MeasurableRemoved extends Activity
{
    protected $eventName = 'API.SitesManager.deleteSite';
    ...
    public function extractParams($eventData)
    {
        ...
        // site should still be available as we use the event triggered before deleting the site
    ...
    {
        return Piwik::translate('ActivityLog_MeasurableRemoved');
    }
}
