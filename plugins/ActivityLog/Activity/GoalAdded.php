...
class GoalAdded extends Activity
{
    protected $eventName = 'API.Goals.addGoal.end';
    ...
    {
        list($idGoal, $finalAPIParameters) = $eventData;

        // $finalAPIParameters = [ className, module, action, parameters ]
        // $finalAPIParameters[parameters] = [ idSite, name, matchAttribute, pattern, patternType,
    ...
    {
        return Piwik::translate('ActivityLog_GoalAdded');
    }
}
