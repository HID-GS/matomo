...
class AnnotationChanged extends Activity
{
    protected $eventName = 'API.Annotations.save.end';
    ...
    public function extractParams($eventData)
    {
        ...
        // $finalAPIParameters[parameters] = [ idSite, idNote, date, note, starred ]
    ...
    {
        return Piwik::translate('ActivityLog_AnnotationChanged');
    }
}
