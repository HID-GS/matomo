...
{
    protected $eventName = 'API.CustomAlerts.addAlert.end';
    ...
    public function extractParams($eventData)
    {
        ...
        // $finalAPIParameters[parameters] = [ name, idSites, period, emailMe, additionalEmails, phoneNumbers, metric,
    ...
    {
        return Piwik::translate('ActivityLog_CustomAlertAdded');
    }
}
