...
class GoalChanged extends Activity
{
    protected $eventName = 'API.Goals.updateGoal.end';
    ...
    {
        list($void, $finalAPIParameters) = $eventData;

        // $finalAPIParameters = [ className, module, action, parameters ]
        // $finalAPIParameters[parameters] = [ idSite, idGoal, name, matchAttribute, pattern, patternType,
        ...
        return [
            'items'     => [
                [
                    'type' => 'goal',
                    'data' => [
                        'id'      => $finalAPIParameters['parameters']['idGoal'],
                        'name'    => urldecode($finalAPIParameters['parameters']['name']),
                        'revenue' => $finalAPIParameters['parameters']['revenue'],
                    ]
                ],
                [
                    'type' => 'measurable',
    ...
    {
        return Piwik::translate('ActivityLog_GoalChanged');
    }
}
