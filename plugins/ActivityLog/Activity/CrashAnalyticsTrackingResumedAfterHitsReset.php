...
class CrashAnalyticsTrackingResumedAfterHitsReset extends Activity
{
    protected $eventName = 'CrashAnalytics.resumeTrackingAfterHitsReset';
    ...
    {
        return Piwik::translate('ActivityLog_CrashAnalyticsResumeAfterHitsReset');
    }
}
