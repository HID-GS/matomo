...
class CustomAlertChanged extends Activity
{
    protected $eventName = 'API.CustomAlerts.editAlert.end';
    ...
    {
        list($idAlert, $finalAPIParameters) = $eventData;

        // $finalAPIParameters = [ className, module, action, parameters ]
        // $finalAPIParameters[parameters] = [ idAlert, name, idSites, period, emailMe, additionalEmails, phoneNumbers, metric,
        //                                     metricCondition, metricValue, comparedTo, reportUniqueId, reportCondition, reportValue ]
    ...
    {
        return Piwik::translate('ActivityLog_CustomAlertChanged');
    }
}
