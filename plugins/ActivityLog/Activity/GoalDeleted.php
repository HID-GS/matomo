...
class GoalDeleted extends Activity
{
    protected $eventName = 'API.Goals.deleteGoal';
    ...
    public function extractParams($eventData)
    {
        ...
        $idGoal = $finalAPIParameters['idGoal'];
    ...
    {
        return Piwik::translate('ActivityLog_GoalDeleted');
    }
}
