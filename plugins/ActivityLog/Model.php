...
class Model
{
     ...
     * @param null|array $dateArray to filter by date
     * @return array
     */
    public function getEntries($offset = 0, $limit = 25, $filterByUserLogin = null, $filterByActivityType = null, $dateArray = null)
    {
        ...
        if (!empty($dateArray) && !empty($dateArray['startDate']) && !empty($dateArray['endDate'])) {
            $where[] = 'ts_created >= ?';
            $bind[]  = $dateArray['startDate'];
            $where[] = 'ts_created <= ?';
            $bind[]  = $dateArray['endDate'];
        }
     ...
     * @return int
     */
    public function getAvailableEntryCount($filterByUserLogin = null, $filterByActivityType = null, $dateArray = null)
    {
