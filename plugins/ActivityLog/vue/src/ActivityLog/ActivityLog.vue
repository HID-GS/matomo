  ...
  <div class="ActivityLog">
    ...
    <div class="activity-list">
      ...
      <div
        ...
        v-html="$sanitize(getNoDataMessage)"
      >
      </div>
    </div>
    <div
...
export default defineComponent({
  ...
  computed: {
    ...
    getNoDataMessage() {
      const mostRecentActivityDate = ActivityLogStore.getMostRecentActivityDate();
      if (!mostRecentActivityDate) {
        return translate('ActivityLog_NoActivitiesNote', [
          '<strong>',
          '</strong>',
        ]);
      }

      const ctaLink = MatomoUrl.stringify({
        ...MatomoUrl.urlParsed.value,
        date: mostRecentActivityDate,
        period: 'day',
      });

      return translate('ActivityLog_NoActivitiesNoteWithLink', [
        '<strong>',
        '</strong>',
        `<a href="?${ctaLink}">`,
        '</a>',
