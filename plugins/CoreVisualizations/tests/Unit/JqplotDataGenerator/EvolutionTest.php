...
class EvolutionTest extends TestCase
{
    ...
    /**
     * @dataProvider provideHasColumnValueCases
     * @param mixed $value
     */
     ...
     */
    public function provideHasColumnValueCases(): iterable
    {
    ...
    public function testPrecomputeForecastReturnsEmptyForSimpleDataTable(): void
    {
        $generator = $this->createGenerator();
        $this->setGeneratorProperty($generator, 'properties', [
            'show_forecast' => 1,
        ...
        self::assertSame([], $generator->precomputeForecast(new DataTable()));
    }
