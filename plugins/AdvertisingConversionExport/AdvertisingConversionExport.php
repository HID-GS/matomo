...
use Piwik\Plugins\AdvertisingConversionExport\ClickIdProvider\LinkedIn;
...
use Piwik\Plugins\AdvertisingConversionExport\Settings\DisableAdvertisingConversionExport;
...
class AdvertisingConversionExport extends \Piwik\Plugin
{
    ...
    public const DAYS_TO_LOOK_BACK_MIN_VALUE = 1;
    public const DAYS_TO_LOOK_BACK_MAX_VALUE = 365;
    public const DAYS_TO_EXPORT_MIN_VALUE = 1;
    public const DAYS_TO_EXPORT_MAX_VALUE = 100;
    public const ATTRIBUTED_CREDIT_MIN_VALUE = 0;
    public const ATTRIBUTED_CREDIT_MAX_VALUE = 1;
    ...
    public function getClientSideTranslationKeys(&$translationKeys)
    {
        ...
        $translationKeys[] = 'AdvertisingConversionExport_AttributedCredit';
        ...
        $translationKeys[] = 'AdvertisingConversionExport_AttributionModel';
        ...
        $translationKeys[] = 'AdvertisingConversionExport_DaysToExportHelpText';
        ...
        $translationKeys[] = 'AdvertisingConversionExport_ViewExport';
        ...
        $translationKeys[] = 'AdvertisingConversionExport_ExportDescriptionHelpText';
        $translationKeys[] = 'AdvertisingConversionExport_ExportDescriptionPlaceHolder';
        $translationKeys[] = 'AdvertisingConversionExport_ExportNameHelpText';
        ...
        $translationKeys[] = 'AdvertisingConversionExport_Filter';
        $translationKeys[] = 'AdvertisingConversionExport_FilterDescription';
        ...
        $translationKeys[] = 'AdvertisingConversionExport_PolicyRequirementExportDisabledTitle';
        $translationKeys[] = 'AdvertisingConversionExport_PolicyRequirementExportDisabledNote';
        $translationKeys[] = 'AdvertisingConversionExport_PolicyDisabledNotification';
    }
    ...
    {
        // Should be removed in Matomo 6
        // Need to do this for privacy, as the code to not capture the linkedIN clickId will be live with Matomo 5.4.0
        // We should remove the clickID from tracking pageURL if version < 5.4.0-b3
        if (version_compare(Version::VERSION, '5.4.0-b2', '<=')) {
            $parametersToExclude[] = 'li_fat_id';
        }
    }

    public static function isVisitUpdateAndExportDisabled(?int $idSite = null): bool
    {
        try {
            $featureFlagManager = StaticContainer::get(FeatureFlagManager::class);
            if ($featureFlagManager->isFeatureActive(PrivacyCompliance::class)) {
                return DisableAdvertisingConversionExport::getInstance($idSite)->getValue();
            }
        } catch (\Exception $e) {
        }
    ...
    {
        if (!class_exists(CnilPolicy::class)) {
            return; // Just skip if no CnilPolicy for old matomo versions
        }
        $featureFlagManager = StaticContainer::get(FeatureFlagManager::class);
        if ($featureFlagManager->isFeatureActive(PrivacyCompliance::class)) {
            ...
            if ($limitSegmentsSettingEnabled) {
                $list->remove('Referrers_Referrers', 'adClickId');
                $list->remove('Referrers_Referrers', 'adProvider');
            }
        }
    }
}
