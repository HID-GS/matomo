...
<template>
  <div class="manageConversionExport">
    ...
    >
      ...
      {{ translate('AdvertisingConversionExport_PolicyDisabledNotification') }}
    </Notification>
    <div v-if="!editMode">
      <ConversionExportList
        ...
        :is-export-disabled-by-policy="isExportDisabledByPolicy"
      />
    </div>
    <div v-if="editMode">
      <ConversionExportEdit
        ...
        :click-id-providers="clickIdProviders"
        :attribution-models="attributionModels"
        :days-to-look-back-min-value="daysToLookBackMinValue"
        :days-to-look-back-max-value="daysToLookBackMaxValue"
        :days-to-export-min-value="daysToExportMinValue"
        :days-to-export-max-value="daysToExportMaxValue"
        :attributed-credit-min-value="attributedCreditMinValue"
        :attributed-credit-max-value="attributedCreditMaxValue"
        :is-export-disabled-by-policy="isExportDisabledByPolicy"
      />
    </div>
  </div>
