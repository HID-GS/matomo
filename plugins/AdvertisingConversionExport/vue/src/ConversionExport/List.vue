  ...
  <div>
    ...
    >
      ...
      <table v-content-table>
        ...
        <tbody>
          ...
          >
            ...
            <td class="action">
              <a v-if="!isExportDisabledByPolicy"
      ...
      <div
        ...
        v-show="hasWriteAccess && !isExportDisabledByPolicy"
      >
        <a
  ...
  methods: {
    ...
    getEditActionTitle() {
      if (this.isExportDisabledByPolicy) {
        return translate('AdvertisingConversionExport_ViewExport');
      }

      return translate('AdvertisingConversionExport_EditExport');
    },
  },
  computed: {
