      ...
      <div>
        <div name="name">
          <Field
            ...
            :inline-help="translate('AdvertisingConversionExport_ExportNameHelpText')"
          >
          </Field>
        </div>
        <div name="description">
          <Field
            ...
            :inline-help="translate('AdvertisingConversionExport_ExportDescriptionHelpText')"
          >
          </Field>
        </div>
        ...
        <div name="daysToLookBack">
          <Field
            ...
            :min="daysToLookBackMinValue"
            :max="daysToLookBackMaxValue"
            :default-value="30"
            :tabindex="24"
        ...
        <div name="attributionModel">
          <Field
              ...
              @update:model-value="conversionExport.parameters.attributionModel = $event;
                setValueHasChanged()"
              :title="translate('AdvertisingConversionExport_AttributionModel')"
              v-show="conversionExport.type === 'GoogleAds'
        ...
        <div name="attributedCredit">
          <Field
              ...
              @update:model-value="conversionExport.parameters.attributedCredit = $event;
                setValueHasChanged()"
              :title="translate('AdvertisingConversionExport_AttributedCredit')"
              v-show="conversionExport.type === 'GoogleAds'
                && conversionExport.parameters.externalAttributedConversion
                && conversionExport.parameters.externalAttributedConversion !== '0'"
              :tabindex="28"
              :min="attributedCreditMinValue"
              :max="attributedCreditMaxValue"
        ...
        <div name="daysToExport">
          <Field
            ...
            :min="daysToExportMinValue"
            :max="daysToExportMaxValue"
            :tabindex="35"
            :inline-help="$sanitize(daysToExportHelp)"
          >
          </Field>
        </div>
        <div
        ...
        >
          <div class="col s12">
            <label
              v-html="$sanitize(translate('AdvertisingConversionExport_Filter'))"
            />
            <div
              class="form-group row"
              style="margin-bottom: 0;"
            >
              <div class="col s12">
                <p>
              <span
                v-html="$sanitize(translate('AdvertisingConversionExport_FilterDescription'))"
              />
                </p>
              </div>
            </div>
...
export default defineComponent({
  ...
  computed: {
    ...
    daysToExportHelp() {
      return translate('AdvertisingConversionExport_DaysToExportHelpText', [
        '<br />',
        '<a href="https://matomo.org/faq/advertising-conversion-export/why-todays-conversions-will-not-appear-in-the-google-ads-feed/" target="_blank" rel="noreferrer noopener">',
        '</a>',
      ]);
    },
    createButtonText() {
