...
class Configuration
{
    ...
    protected function __construct(
        ...
        $this->daysToExport                 = $daysToExport;
    ...
    {
        self::checkIsExportEnabled($idSite);
    ...
    public function validate(): void
    {
        ...
        $segmentFilter = Common::unsanitizeInputValue($this->segment);
        $segmentFilter = urldecode($segmentFilter);
        new Segment($segmentFilter, [$this->idSite]);
    }
    ...
    public static function checkIsExportEnabled(?int $idSite = null): bool
    {
        if (AdvertisingConversionExport::isVisitUpdateAndExportDisabled($idSite)) {
            throw new Exception('Export disabled due to privacy compliance policy being active');
        }
