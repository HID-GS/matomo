...
5.2.1 - 2026-05-11
- Added spacing between view icon and form name
- Updated form creation inline helptexts

5.2.0 - 2026-04-27
- Added code to disable auto-form creation via separate system setting
- Updated API documentation
- Standardized textarea styling in creation and edit screens

5.1.4 - 2026-04-02
- Added code to sort by form views by default

5.1.3 - 2026-02-02
- Updated API documentation

5.1.2 - 2025-08-18
- Updated condition to handle duplicate entry exception

5.1.1 - 2025-05-13
- Fixed database update issue in 5.1.0

5.1.0 - 2025-05-12
- Added an option to trigger goals on form conversion

5.0.16 - 2025-04-01
- Started showing form name and segment condition in the visit log popup title

5.0.15 - 2025-03-17
- Increased minimum Matomo core version to 5.0.0-rc1
