      ...
      <p>
        ...
        <span v-if="isVisitorLogEnabled">
          <a
            ...
            'FormAnalytics_SegmentedVisitorLogPopupTitleFormStarter')"
          >
          ...
          <a
            ...
            'FormAnalytics_SegmentedVisitorLogPopupTitleFormSubmitters')"
          >
            <span class="icon-visitor-profile"></span>
          ...
          <a
            ...
            'FormAnalytics_SegmentedVisitorLogPopupTitleFormConverters')"
          >
            <span class="icon-visitor-profile"></span>
...
const { faSegmentedVisitorLog } = window as any;
...
export default defineComponent({
  ...
  methods: {
    ...
    showSegmentedVisitorLog(condition: string, conditionTranslationText: string) {
      const segment = this.segment ? `;${this.segment}` : '';
      faSegmentedVisitorLog.show(
        'FormAnalytics.get',
        `form_name==${this.form.idsiteform};${condition}${segment}`,
        {},
        translate(conditionTranslationText, Matomo.helper.htmlEntities(this.form.name)),
      );
    },
  },
  computed: {
