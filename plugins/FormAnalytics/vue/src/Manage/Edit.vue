      ...
      <div>
        <div name="name">
          <Field
            ...
            :maxlength="50"
            :placeholder="translate('FormAnalytics_FieldNamePlaceholderV2')"
            :inline-help="translate('FormAnalytics_FormNameHelpText')"
          >
          </Field>
        </div>
        <div name="description">
          <Field
            ...
            :placeholder="translate('FormAnalytics_FieldDescriptionPlaceholderV2')"
            :inline-help="$sanitize(formDescriptionHelp)"
          >
          </Field>
        </div>
        <div
        ...
        >
          <div class="col s12">
            <h3>4) {{ translate('FormAnalytics_GoalConversionRulesTitle') }}:</h3>
          </div>
        </div>
        <div
            class="form-group row"
        ...
        >
          <div class="col s12">
            <label style="color: unset !important;"
                   v-text="translate('FormAnalytics_GoalConversionRulesDescription')"
            ></label>
          </div>
        </div>
        <div
            class="form-group row"
        >
          <div class="col s6 trackGoal">
            <Field
                uicontrol="select"
                name="goal"
                :model-value="idGoal"
                @update:model-value="this.form.idgoal = $event; setValueHasChanged()"
...
export default defineComponent({
  ...
  created() {
    ...
    FormAnalyticsStore.getAllGoals(Matomo.idSite).then((rules) => {
      this.allGoals = rules;
    });
  ...
  computed: {
    ...
    formDescriptionHelp() {
      ...
      return translate(
        'FormAnalytics_FormDescriptionHelpText',
        `<a target="_blank" rel="noreferrer" href="${link}">`,
        '</a>',
      );
    },
