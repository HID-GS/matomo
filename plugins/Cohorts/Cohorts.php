...
class Cohorts extends \Piwik\Plugin
{
    ...
    public function getClientSideTranslationKeys(&$result)
    {
        ...
        $result[] = 'Cohorts_CohortsNumber';
        $result[] = 'Cohorts_CohortsNumberHelpText';
        $result[] = 'General_Metric';
        $result[] = 'General_DailyReport';
        $result[] = 'General_WeeklyReport';
        $result[] = 'General_MonthlyReport';
        $result[] = 'General_YearlyReport';
        $result[] = 'Intl_PeriodDay';
        $result[] = 'Intl_PeriodWeek';
        $result[] = 'Intl_PeriodMonth';
        $result[] = 'Intl_PeriodYear';
    }
}
