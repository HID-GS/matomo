...
class VisitorRetentionPercent extends ProcessedMetric
{
    ...
    public function compute(Row $row)
    {
        ...
        $cohortsForPeriod = $this->allTables->hasTable($tableLabel) ? $this->allTables->getTable($tableLabel) : '';
        ...
        return min($result, 1.0); // due to how visitor_days_since_first was tracked, some cells can have > 100% visitors
    }
