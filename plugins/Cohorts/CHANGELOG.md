...
5.1.6 - 2025-11-24
- Improved url parameter checking for Get Cohorts report

5.1.5 - 2025-09-01
- Added dashboard widget for the updated Cohorts Chart

5.1.4 - 2025-07-07
- Textual change

5.1.3 - 2025-04-14
- Adjusted Cohorts Chart to stop cohort lines when no more data exists for that cohort

5.1.2 - 2025-03-31
- Changed the position of metrics filter
- Improved text for number of cohorts dropdown
- Corrected issue preventing closing the Cohorts widget

5.1.1 - 2025-01-28
- Changed period default to empty from null, to not throw an exception if undefined
- Updated cover images to show new visualisation change
