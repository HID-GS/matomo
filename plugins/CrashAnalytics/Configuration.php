...
class Configuration
{
    public const KEY_DELETE_CRASH_DATA_OLDER_THAN = 'delete_crash_data_older_than';
    public const KEY_DATATABLE_ARCHIVING_MAXIMUM_ROWS_CRASHES = 'datatable_archiving_maximum_rows_crashes';
    public const KEY_DATATABLE_ARCHIVING_MAXIMUM_ROWS_CRASH_TOPTABLE = 'datatable_archiving_maximum_rows_crash_toptable';
    public const KEY_DATATABLE_ARCHIVING_MAXIMUM_ROWS_CRASH_SUBTABLE = 'datatable_archiving_maximum_rows_crash_subtable';
    public const KEY_CONSIDER_CRASH_NEW_AFTER_N_DAYS = 'consider_crash_new_after_n_days';
    public const KEY_CRASH_RANKING_QUERY_LIMIT = 'crash_archiving_ranking_query_row_limit';

    public const DEFAULT_DELETE_CRASH_DATA_OLDER_THAN = 90;
    public const DEFAULT_DATATABLE_ARCHIVING_MAXIMUM_ROWS_CRASHES = 500;
    public const DEFAULT_DATATABLE_ARCHIVING_MAXIMUM_ROWS_CRASH_TOPTABLE = 500;
    public const DEFAULT_DATATABLE_ARCHIVING_MAXIMUM_ROWS_CRASH_SUBTABLE = 100;
    public const DEFAULT_CONSIDER_CRASH_NEW_AFTER_N_DAYS = 365 * 2;
    public const DEFAULT_CRASH_RANKING_QUERY_LIMIT = 50000;
