...
class Metrics
{
    public const CRASH_OCCURRENCES = 'nb_crash_occurrences';
    public const VISITS_WITH_CRASH = 'nb_visits_with_crash';
    public const UNIQUE_CRASHES = 'nb_uniq_crashes';
    public const NEW_CRASHES = 'nb_new_crashes';
    public const DISAPPEARED_CRASHES = 'nb_disappeared_crashes';
    public const REAPPEARED_CRASHES = 'nb_reappeared_crashes';
    public const PAGEVIEWS_WITH_CRASH = 'nb_pageview_with_crash';
    public const IGNORED_CRASHES = 'nb_ignored_crashes';
    ...
    public static function getMetricAggregationOps()
    {
        ...
        // than a day.
        $useThisMetricAggregationOp = function ($op, $thisValue) {
            return $thisValue;
        };
