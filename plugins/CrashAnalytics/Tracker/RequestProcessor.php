...
{
    public const TRACKING_PARAM_ERROR_MESSAGE = 'cra';
    public const TRACKING_PARAM_ERROR_STACK = 'cra_st';
    public const TRACKING_PARAM_ERROR_CATEGORY = 'cra_ct';
    public const TRACKING_PARAM_ERROR_TYPE = 'cra_tp';
    public const TRACKING_PARAM_RESOURCE_URI = 'cra_ru';
    public const TRACKING_PARAM_RESOURCE_LINE = 'cra_rl';
    public const TRACKING_PARAM_RESOURCE_COLUMN = 'cra_rc';
