...
{
    public const METRIC_NAME = 'nb_pageview_crash_rate';
    public const TRANSLATION_ID = 'CrashAnalytics_PageviewCrashRate';
    public const DOCUMENTATION_TRANSLATION_ID = 'CrashAnalytics_PageviewsWithCrashRateDocumentation';
