...
{
    public const METRIC_NAME = 'visits_crash_rate';
    public const TRANSLATION_ID = 'CrashAnalytics_VisitsCrashRate';
    public const DOCUMENTATION_TRANSLATION_ID = 'CrashAnalytics_VisitsCrashRateDocumentation';
    ...
    public function compute(Row $row)
    {
        ...
        return Piwik::getQuotientSafe($visitsWithCrash, $this->nbVisits, $precision = 4);
    }
