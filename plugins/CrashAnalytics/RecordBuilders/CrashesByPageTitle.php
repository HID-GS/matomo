...
class CrashesByPageTitle extends CrashesByDimension
{
    public const RECORD_NAME = 'CrashAnalytics_ByPageTitle';

    public function getDimensionColumn(): string
    {
        return 'log_crash_event.idaction_name';
    }
    ...
    public function getExtraFrom(): array
    {
        return [
            [
                'table' => 'log_action',
                'joinOn' => 'log_action.idaction = log_crash_event.idaction_name',
            ],
        ];
    }
