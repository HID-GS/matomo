...
class GetCrashesForPageTitle extends Base
{
    protected function init()
    {
        ...
        $this->name          = Piwik::translate('CrashAnalytics_CrashesByPageTitleSubtable');
        $this->documentation = Piwik::translate('CrashAnalytics_CrashesByPageTitleSubtableDocumentation');
