...
class GetCrashesByFirstParty extends Base
{
    protected function init()
    {
        ...
        $this->name          = Piwik::translate('CrashAnalytics_CrashesByFirstPartyUrl');
        $this->documentation = Piwik::translate('CrashAnalytics_CrashesByFirstPartyUrlDocumentation');
    ...
    public function configureWidgets(WidgetsList $widgetsList, ReportWidgetFactory $factory)
    {
        ...
        $widget->setName('CrashAnalytics_FirstParty');
