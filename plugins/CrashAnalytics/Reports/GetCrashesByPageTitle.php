...
class GetCrashesByPageTitle extends Base
{
    protected function init()
    {
        ...
        $this->name          = Piwik::translate('CrashAnalytics_CrashesByPageTitle');
        $this->documentation = Piwik::translate('CrashAnalytics_CrashesByPageTitleDocumentation');
        $this->subcategoryId = 'CrashAnalytics_AllCrashes';
        $this->actionToLoadSubTables = 'getCrashesForPageTitle';
        $this->order = 10;
    ...
    public function configureWidgets(WidgetsList $widgetsList, ReportWidgetFactory $factory)
    {
        ...
        $widget->setName('CrashAnalytics_PageTitle');
