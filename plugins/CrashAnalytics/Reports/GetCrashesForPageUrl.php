...
class GetCrashesForPageUrl extends Base
{
    protected function init()
    {
        ...
        $this->name          = Piwik::translate('CrashAnalytics_CrashesByPageUrlSubtable');
        $this->documentation = Piwik::translate('CrashAnalytics_CrashesByPageUrlSubtableDocumentation');
