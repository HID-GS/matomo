...
class GetNewCrashes extends Base
{
    protected function init()
    {
        ...
        $this->name          = Piwik::translate('CrashAnalytics_NewCrashesReport');
        $this->documentation = Piwik::translate('CrashAnalytics_NewCrashesDocumentation');
    ...
    public function configureWidgets(WidgetsList $widgetsList, ReportWidgetFactory $factory)
    {
        ...
        $widget->setName(Piwik::translate('CrashAnalytics_New'));
