    ...
    <div class="form-group">
      <div name="name">
        <Field
          uicontrol="text"
          name="name"
          :placeholder="translate('AbTesting_FieldNamePlaceholder')"
          :model-value="experiment?.name"
          @update:model-value="$emit('updateProperty', { prop: 'name', value: $event })"
          :title="translate('General_Name')"
          :maxlength="50"
          :inline-help="translate('AbTesting_FieldExperimentNameHelpText', 50)"
        >
        </Field>
      </div>
    </div>
    <div class="form-group">
      <div name="description">
        <Field
          ...
          :inline-help="translate('AbTesting_FieldDescriptionHelpText')"
        >
        </Field>
      </div>
    </div>
