          ...
          >
            <div class="col-md-12">
              ...
              <Redirects
                ...
                :forward-all-query-params="experiment?.forward_all_query_params === 1"
                @update:model-value="experiment.variations = $event; setValueHasChanged()"
                @update:forward-utm-params="setForwardUtmParams"
                @update:forward-all-query-params="setForwardAllQueryParams"
              />
              <Schedule
...
export default defineComponent({
  ...
  methods: {
    ...
    setForwardAllQueryParams(forwardAllQueryParams: boolean) {
