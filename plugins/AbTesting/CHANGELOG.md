...
5.5.3 - 2026-05-11
- Updated A/B test creation inline helptexts
...
5.5.1 - 2026-02-02
- updated api documentation
- System setting disable field name updated

5.5.0 - 2025-12-08
- Added support for core CNIL policy control of setting values to disable AbTesting

5.4.0 - 2025-11-24
- Added option to disable AbTesting globally
...
- Fixed sort not working as expected

5.3.1 - 2025-03-31
- Adjusted client storage lifespan to 13 months

5.3.0 - 2025-02-03
- Added an option to forward all query params on redirect
