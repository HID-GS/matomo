...
class Experiment
{
    ...
    public function install()
    {
        DbHelper::createTable($this->table, "
                  ...
                  `forward_utm_params` TINYINT(0) UNSIGNED NOT NULL DEFAULT 0,
                  `forward_all_query_params` TINYINT(0) UNSIGNED NOT NULL DEFAULT 0,
    ...
    private function enrichExperiment($experiment)
    {
        ...
        if (!empty($experiment['start_date']) && strpos($experiment['start_date'], '0000-00-00') === 0) {
            $experiment['start_date'] = null;
        }
        if (!empty($experiment['end_date']) && strpos($experiment['end_date'], '0000-00-00') === 0) {
