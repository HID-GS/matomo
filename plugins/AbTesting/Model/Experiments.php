...
class Experiments
{
    ...
    protected function enrichExperiment($experiment)
    {
        ...
        /** @var Date|null $start */         /** @var Date|null $end */
        ...
        $experiment['duration'] = $this->getExperimentDuration($start, $experiment['status'] === Experiments::STATUS_RUNNING ? Date::now() : $end);
    ...
    public function createExperiment($idSite, $name, $description, $hypothesis, $variations, $includedTargets, $successMetrics, $confidenceThreshold)
    {
        ...
        $currentTs = $this->getCurrentDateTime();
        $columns = array(
            'idsite' => $idSite,
            'name' => $name,
    ...
    public function updateExperiment(
        ...
        $columns = array(
            ...
            'forward_all_query_params' => $forwardAllQueryParams,
        );
