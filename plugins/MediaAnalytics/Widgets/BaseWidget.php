...
abstract class BaseWidget extends Widget
{
    ...
    public static function addMediaSegment($segment)
    {
        if (!empty($segment) && is_string($segment) && strpos($segment, Segment::NAME_SPENT_TIME) !== false) {
        ...
        return urlencode(\Piwik\Segment::combine($segment, SegmentExpression::AND_DELIMITER, $mediaSegment));
    }
    ...
    public static function getMediaSegment()
    {
        ...
        return self::addMediaSegment($segment);
    }
}
